  ...
  def download_mangas(self):
    for vol in self.mangas.keys():
      ...
      for chapter in self.mangas[vol]:
        ...
        dirName = 'Vol ' + self.get_vol_name(vol) + '/Capitulo ' +  self.get_chapter_name(chapter)
...
# md.download_image('http://reader.jokerfansub.com/content/comics/_one_piece_54fbdf740682e/1_0_romance_dawn__el_amanecer_de_la_aventura_55f8907e4931a/000.jpg', 'Vol 0001/001.jpg')